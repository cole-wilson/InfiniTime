...
WatchFaceAnalog::WatchFaceAnalog(Pinetime::Applications::DisplayApp* app,
  ...
  lv_obj_set_style_local_line_width(steps, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 2);
  ...
  lv_obj_set_style_local_line_color(timer, LV_OBJ_PART_MAIN,  LV_STATE_DEFAULT, lv_color_hex(0x333333));
